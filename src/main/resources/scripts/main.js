...
function $s_Lfi_kimmoeklund_js_Hello__main__AT__V(args) {
  $m_Lfi_kimmoeklund_js_Hello$().main__AT__V(args)
}
/** @constructor */
function $c_Lfi_kimmoeklund_js_Hello$() {
  /*<skip>*/
}
$c_Lfi_kimmoeklund_js_Hello$.prototype = new $h_O();
$c_Lfi_kimmoeklund_js_Hello$.prototype.constructor = $c_Lfi_kimmoeklund_js_Hello$;
/** @constructor */
function $h_Lfi_kimmoeklund_js_Hello$() {
  /*<skip>*/
}
$h_Lfi_kimmoeklund_js_Hello$.prototype = $c_Lfi_kimmoeklund_js_Hello$.prototype;
$c_Lfi_kimmoeklund_js_Hello$.prototype.main__AT__V = (function(args) {
  ...
  this.registerEventHandler__V()
});
$c_Lfi_kimmoeklund_js_Hello$.prototype.registerEventHandler__V = (function() {
  var \u03b41$ = document.getElementById("permission-form");
  \u03b41$.addEventListener("reset", ((e) => {
    e.target.reset()
  }))
});
var $d_Lfi_kimmoeklund_js_Hello$ = new $TypeData().initClass({
  Lfi_kimmoeklund_js_Hello$: 0
}, false, "fi.kimmoeklund.js.Hello$", {
  Lfi_kimmoeklund_js_Hello$: 1,
  O: 1
});
$c_Lfi_kimmoeklund_js_Hello$.prototype.$classData = $d_Lfi_kimmoeklund_js_Hello$;
var $n_Lfi_kimmoeklund_js_Hello$;
function $m_Lfi_kimmoeklund_js_Hello$() {
  if ((!$n_Lfi_kimmoeklund_js_Hello$)) {
    $n_Lfi_kimmoeklund_js_Hello$ = new $c_Lfi_kimmoeklund_js_Hello$()
  };
  return $n_Lfi_kimmoeklund_js_Hello$
}
/** @constructor */
...
$L0 = new $c_RTLong(0, 0);
$d_J.zero = $L0;
$s_Lfi_kimmoeklund_js_Hello__main__AT__V(new ($d_T.getArrayOf().constr)([]));
}).call(this);
